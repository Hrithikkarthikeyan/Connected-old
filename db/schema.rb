...
ActiveRecord::Schema.define(version: 2022_08_01_130009) do
  ...
  create_table "views", force: :cascade do |t|
    ...
    t.index ["friend_id"], name: "index_views_on_friend_id"
  end
  ...
  add_foreign_key "requests", "accounts", column: "friend_id"
  add_foreign_key "views", "accounts"
  add_foreign_key "views", "accounts", column: "friend_id"
end
